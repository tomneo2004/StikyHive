...
- (void)_setupCancelButton
{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1)
    {
        ...
        [self.cancelButton setFrame:CGRectMake(20, winRect.size.height-60, 58, 30)];
...
- (void)_setupUseButton
{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1)
    {
        ...
        [self.useButton setFrame:CGRectMake(winRect.size.width-90, winRect.size.height-60, 70, 30)];
...
- (void)_setupToolbar
{
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        UILabel *tempLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, viewSize.height-h2, viewSize.width, h2)];
